// Satellite: diamond / rhombus — clean radar-style tracked asset marker
...
export function drawSatelliteIcon(ctx: CanvasRenderingContext2D, color: string): void {
  ctx.fillStyle = color;
  ...
  // Gives depth / "3D" look without actual 3D
