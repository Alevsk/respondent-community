...
6. Validate: `go test ./internal/ingest/declarative/... -run TestValidateSourceDefinitions -v`

## Reference

- [FEEDER_DECLARATIVE_SOURCES.md](../docs/FEEDER_DECLARATIVE_SOURCES.md) — Full system documentation (schema, CEL, transports, parser transforms, lookup tables)
- [ONBOARDING_NEW_SOURCES.md](../docs/ONBOARDING_NEW_SOURCES.md) — Step-by-step guide for adding new sources
